  ...
  >
    ...
    >
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        Tugas selesai 8 dari total 10 tugas.
Tercapai 80% dari target minggu ini.
      </p>
    </div>
    ...
    <div class="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
      <div class="flex flex-col items-start">
        ...
        <p
          class="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg pl-7"
        >
          8
      ...
      <div class="flex flex-col items-start">
        <p class="mb-1 text-gray-500 text-theme-xs dark:text-gray-400 sm:text-sm pl-">
          Total Tugas
        </p>
        <p
          class="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg pl-6"
        >
          10
